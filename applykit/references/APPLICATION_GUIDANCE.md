...
- Keep short answers under 120 words unless the form requires more.
- Prefer concrete, verified examples over generic enthusiasm.
- Do not copy the job description back into answers.

## Attachments

- Upload the canonical résumé unless the candidate supplies another file explicitly.
- Do not generate or upload fabricated portfolios, transcripts, or references.
